...
| `Ass_array_find.js` | Searches for an element in an array |
| `Ass_obj.js` | Performs operations on employee objects |
| `Ass_sum_array.js` | Calculates the sum of array elements |
